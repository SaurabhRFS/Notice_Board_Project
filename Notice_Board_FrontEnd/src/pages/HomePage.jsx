...
function HomePage() {
  ...
  const handleCreateNotice = async () => {
    ...
    if (newNoticeFiles && newNoticeFiles.length > 0) {
      // Append each file with the key 'files' (plural)
      // Spring Boot will collect these into a List<MultipartFile>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <input type="file" multiple onChange={(e) => setNewNoticeFiles([...e.target.files])} className="w-full text-sm text-slate-500"/>
                  </div>
                </div>
