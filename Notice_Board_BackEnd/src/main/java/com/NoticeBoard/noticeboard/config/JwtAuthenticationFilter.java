...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final UserDetailsService userDetailsService; // <-- This will be our new class

    // We now ask for the generic UserDetailsService
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // This now calls our new "CustomUserDetailsService"
